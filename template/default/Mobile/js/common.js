var yhcmsApp = {
	...
	getProList : function (cid) {
		var oUrl = '/index.php/Api/getlist';
		var page = 2;
					...
					if(data['status'] == 'success') {
						if(data['data'] != null) {
							for(var i=0; i<data['data'].length;i++) {
								var html = '<dd>';
								html+= '<a href="/Mobile'+data['data'][i]['url']+'"><img src="'+ data['data'][i]['img']+ '" width="100%"></a>';
								html+= '<a href="/Mobile'+data['data'][i]['url']+'">'+data['data'][i]['title']+'</a>';
								html+='</dd>';
								$('.dllist').append(html);
							}
							page++;
				...
				success : function (data) {
					...
					if(data['status'] == 'success') {
						if(data['data'] != null) {
							for(var i=0; i<data['data'].length;i++) {
								var html = '<li>';
								html+= '<a href="/Mobile'+data['data'][i]['url']+'"><p>'+data['data']['title']+'</p><i class="fa fa-angle-right fa-gray"></i></a>';
								html+='</li>';
								$('.dllist').append(html);
							}
							page++;
