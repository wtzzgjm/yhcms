...
class Page {
    ...
    public function show() {
        ...
        if($this->url){
            ...
            if(strtolower(GROUP_NAME) == 'mobile' || strtolower(GROUP_NAME) == 'app'){
                $url        =   rtrim(U('/'.GROUP_NAME.'/'.$this->url,'',false),$depr).$depr.'__PAGE__';
            } else{
        ...
        //$ppppp = $this->totalRows."~~~"$this->listRows;
        //$ppppp .= $nowCoolPage."~~~".$this->coolPage;
        ...
        return "<div class='showpage'>".$pageStr."</div>".$ppppp;
    }
